  ...
  <div class="list-query-container">
    ...
    <div class="table-wrapper">
      ...
      >
        ...
        <el-table-column prop="port" label="port" width="150" align="center" />
...
import QAgentServerAddView from "@/views/qagent/QAgentServerAddView.vue";
...
const getTableList = async () => {
  try {
    ...
    const rows = await serverApi.list(params)
